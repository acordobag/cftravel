import { Component, PLATFORM_ID, Inject, Input, Output, EventEmitter, OnInit, OnChanges, ElementRef, forwardRef } from '@angular/core';
    ...
    <div class="custom-autocomplete" *ngIf="!isSettingsError">
      <div class="custom-autocomplete__container" >
        <div class="custom-autocomplete__input" [ngClass]="{'button-included':settings.showSearchButton}">
          <input class="form-control" [(ngModel)]="value" (click)="searchinputClickCallback($event)"  (keyup)="searchinputCallback($event)"
...
export class AutoCompleteComponent implements OnInit, OnChanges, ControlValueAccessor {
  ...
  private moduleInit(): any {
    ...
    this.value = this.settings.inputString;
  }
